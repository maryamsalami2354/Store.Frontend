...
//#region node_modules/jalaali-js/index.js
var require_jalaali_js = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		toJalaali,
		toGregorian,
		isValidJalaaliDate,
	...
	function d2j(jdn) {
		var gy = d2g(jdn).gy, jy = gy - 621, r = jalCal(jy, false), jdn1f = g2d(gy, 3, r.march), jd, jm, k = jdn - jdn1f;
		if (k >= 0) if (k <= 185) {
			jm = 1 + div(k, 31);
			jd = mod(k, 31) + 1;
			return {
