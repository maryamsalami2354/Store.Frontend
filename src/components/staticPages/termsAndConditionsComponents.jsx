...
const termsSections = [
    {
        ...
        content: [
            'تمامی اطلاعات شخصی کاربران نزد فروشگاه کیان شاپ محفوظ بوده و به هیچ عنوان در اختیار شخص یا سازمان ثالث قرار نمی‌گیرد.',
            'اطلاعات بانکی و پرداخت کاربران مستقیماً از طریق درگاه بانکی معتبر و با پروتکل SSL رمزنگاری شده انجام می‌شود و هیچ‌گونه اطلاعات بانکی در سرورهای کیان شاپ ذخیره نمی‌شود.',
            'کیان شاپ متعهد می‌شود از اطلاعات ثبت‌نامی کاربران (نام، شماره تماس، آدرس) فقط برای ارسال سفارشات و اطلاع‌رسانی استفاده کند.',
            'کاربران می‌توانند در هر زمان از طریق پنل کاربری، اطلاعات شخصی خود را ویرایش یا حذف کنند.',
            'در صورت بروز هرگونه مشکل امنیتی، تیم فنی کیان شاپ در کمتر از ۲۴ ساعت اقدام به رفع آن می‌نماید.',
        ]
    },
    {
        id: 2,
        ...
        content: [
            ...
            'مسئولیت حفظ و نگهداری از رمز عبور بر عهده کاربر بوده و کیان شاپ هیچ‌گونه مسئولیتی در قبال سوءاستفاده احتمالی ندارد.',
            'کاربران موظفند در صورت مشاهده هرگونه استفاده غیرمجاز از حساب خود، بلافاصله موضوع را به پشتیبانی اطلاع دهند.',
            'کیان شاپ این حق را دارد در صورت تخلف کاربر، حساب وی را مسدود یا معلق کند.',
    ...
    },
    {
        ...
        content: [
            ...
            'پرداخت هزینه سفارش از طریق درگاه بانکی معتبر، کارت به کارت و کیف پول کیان شاپ امکان‌پذیر است.',
            ...
            'در صورت بروز خطا در قیمت‌گذاری، کیان شاپ این حق را دارد که سفارش را لغو و وجه را عودت دهد.',
        ]
    },
    {
        id: 4,
        ...
        content: [
            ...
            'کیان شاپ امکان ارسال به سراسر ایران را فراهم کرده است. ارسال به کشورهای دیگر امکان‌پذیر نیست.',
    ...
    },
    {
        ...
        content: [
            ...
            'وجه پرداختی پس از تایید سلامت کالا توسط کارشناسان کیان شاپ، حداکثر تا ۷۲ ساعت به حساب کاربر عودت داده می‌شود.',
    ...
    },
    {
        ...
        content: [
            'کیان شاپ به عنوان فروشگاه اینترنتی، مسئولیت صحت اطلاعات فنی محصولات را می‌پذیرد.',
            'تصاویر محصولات صرفاً جهت اطلاع‌رسانی بوده و ممکن است با محصول اصلی تفاوت‌های جزئی داشته باشد.',
            'کیان شاپ در قبال خسارات ناشی از استفاده نادرست از محصول مسئولیتی ندارد.',
            'در صورت بروز فورس ماژور (بلایای طبیعی، جنگ و...) کیان شاپ از تعهدات زمانی خود مبرا خواهد بود.',
            'کیان شاپ این حق را دارد که در هر زمان قوانین را بدون اطلاع قبلی به‌روزرسانی کند.',
            'کلیه محتوای سایت متعلق به کیان شاپ بوده و کپی‌برداری از آن پیگرد قانونی دارد.',
        ]
    },
    {
        id: 7,
        ...
        content: [
            'تمامی محتوا، طراحی، لوگو و نرم‌افزارهای این وب‌سایت متعلق به کیان شاپ بوده و تحت حمایت قوانین مالکیت فکری است.',
            ...
            'کاربران با ثبت نظرات در سایت، به کیان شاپ حق استفاده و نمایش آن را می‌دهند.',
        ]
    },
    {
        id: 8,
        ...
        content: [
            'پشتیبانی کیان شاپ همه روزه از ساعت ۹ صبح تا ۹ شب پاسخگوی مشتریان است.',
            'از طریق ایمیل support@kianshop.ir و بخش "تماس با ما" در سایت با ما در ارتباط باشید.',
            'میانگین زمان پاسخگویی به سوالات کمتر از ۲ ساعت در ساعات کاری است.',
            'در صورت نارضایتی، شکایت خود را از طریق ایمیل complaints@kianshop.ir ثبت کنید.',
                ...
                <div className="relative mt-3 overflow-hidden rounded-2xl bg-gradient-to-br from-[#002874] via-[#003399] to-[#1a1a5e] p-6 sm:p-8 lg:p-10 mb-6">
                    ...
                    <div className="relative z-10 text-center">
                        ...
                        <p className="text-sm sm:text-base text-white/70 max-w-2xl mx-auto leading-relaxed">
                            ...
                            استفاده از خدمات فروشگاه اینترنتی کیان شاپ به معنی پذیرش کامل این قوانین است.
                        </p>
                    </div>
                </div>
