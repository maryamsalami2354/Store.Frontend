...
const testimonials = [
    {
        ...
        text: 'از وقتی به کیان شاپ پیوستم، فروشم ۳ برابر شده. پنل ساده و کمیسیون منصفانه واقعاً عالیه.',
        avatar: null,
        rating: 5,
    },
    {
    ...
    },
    {
        ...
        text: 'داشبورد تحلیلی کیان شاپ بهم کمک کرد رفتار مشتریام رو بهتر بفهمم و فروشمو بهینه کنم.',
        avatar: null,
        rating: 4,
    },
    {
        ...
        name: 'رضا کریمی',
        shop: 'تکنوکالا',
        text: 'بهترین تصمیم کاری من پیوستن به کیان شاپ بود. لجستیک و انبارداری رو کامل بهشون سپردم.',
        avatar: null,
        rating: 5,
    },
];
    ...
    <div className="mb-8">
        <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xl mx-auto">
                تجربه واقعی فروشندگان کیان شاپ
            </p>
        </div>
